...
function Id(props) {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(0),
      humidity = _useState[0],
      setHumidity = _useState[1];
  ...
  var humidityData = _firebase_index__WEBPACK_IMPORTED_MODULE_6__["firebase"].database().ref("/users/" + props.user + "/devices/" + id + "/humidity");
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    humidityData.on('value', function (data) {
      setHumidity(data.val());
    });
...
//# sourceMappingURL=[id].js.b077fee29823d08cfd98.hot-update.js.map