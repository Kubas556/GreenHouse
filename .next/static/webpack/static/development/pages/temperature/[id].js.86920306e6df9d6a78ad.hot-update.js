  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    ...
    if (initValue != undefined) {
      ...
      for (var i = 0; i < segCount; i++) {
        ...
        var line = '<div rotate=' + _handAngle + ' style="transform:rotate(' + _handAngle + 'deg)!important;width:' + lineContainerSizes.width + ';" class="lineContainer">' + '<div class="line"></div>' + '<div class="valueGroup">' + '<div class="valueLine"></div>' + '<div>' + Math.round(j) + '</div>' + '</div>' + '</div>';
...
//# sourceMappingURL=[id].js.86920306e6df9d6a78ad.hot-update.js.map