...
function Termostat(props) {
  ...
  function onMove(e) {
    if (drag) {
      ...
      if (angle2 < 0) angle2 = -(angle2 + angleOverlap * 2);else angle2 = -(angle2 - maxAngle + angleOverlap);
      console.log(angle2);
...
//# sourceMappingURL=[id].js.0fbd82e6f912468ceba4.hot-update.js.map