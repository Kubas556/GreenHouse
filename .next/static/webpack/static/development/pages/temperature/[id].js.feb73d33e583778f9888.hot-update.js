  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    ...
    if (initValue != undefined) {
      ...
      for (var i = 0; i < segCount; i++) {
        ...
        var line = '<div rotate=' + _handAngle + ' style="transform:rotate(' + _handAngle + 'deg)!important;width:' + lineContainerSizes.width + ';" class="lineContainer">' + '<div class="line"></div>' + '<div class="valueGroup">' + '<div class="valueLine"></div>' + '<div style="transform:rotate(' + -_handAngle + 'deg)">' + Math.round(j) + '</div>' + '</div>' + '</div>';
...
//# sourceMappingURL=[id].js.feb73d33e583778f9888.hot-update.js.map