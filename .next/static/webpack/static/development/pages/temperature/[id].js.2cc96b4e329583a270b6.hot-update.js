...
function Termostat(props) {
  ...
  function onMove(e) {
    if (drag) {
      ...
      if (angle2 < 0) angle2 = -(angle2 - angleOverlap);else angle2 = -(angle2 - maxAngle - 45);
      console.log(angle2);
...
//# sourceMappingURL=[id].js.2cc96b4e329583a270b6.hot-update.js.map