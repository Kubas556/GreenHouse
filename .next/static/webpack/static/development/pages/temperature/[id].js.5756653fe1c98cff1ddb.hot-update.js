...
function Termostat(props) {
  ...
  function onMove(e) {
    if (drag) {
      ...
      if (angle2 > 360) angle2 -= 360; //angle2=(maxAngle-angle2);
...
//# sourceMappingURL=[id].js.5756653fe1c98cff1ddb.hot-update.js.map