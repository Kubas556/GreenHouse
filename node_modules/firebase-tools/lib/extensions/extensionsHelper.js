...
function validateSpec(spec) {
    ...
    for (let param of spec.params || []) {
        ...
        if (param.type && !_.includes(extensionsApi_1.ParamType, param.type)) {
        ...
        if (!param.type || param.type == extensionsApi_1.ParamType.STRING) {
            if (param.options) {
        ...
        if (param.type && (param.type == extensionsApi_1.ParamType.SELECT || param.type == extensionsApi_1.ParamType.MULTISELECT)) {
