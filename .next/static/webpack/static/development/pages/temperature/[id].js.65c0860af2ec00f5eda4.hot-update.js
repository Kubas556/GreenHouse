...
function Termostat(props) {
  ...
  function onMove(e) {
    if (drag) {
      ...
      if (angle2 < 0) angle2 = -(angle2 - angleOverlap);else angle2 = -(angle2 - maxAngle - (maxAngle - 180) / 2);
      console.log(angle2);
...
//# sourceMappingURL=[id].js.65c0860af2ec00f5eda4.hot-update.js.map