...
function Termostat(props) {
  ...
  function onMove(e) {
    if (drag) {
      ...
      console.log(angle2);
      if (angle2 < 0) angle2 = -(120 - angle2);else angle2 = -(angle2 - maxAngle + angleOverlap);
...
//# sourceMappingURL=[id].js.17f4729eb7d1ffd76a80.hot-update.js.map