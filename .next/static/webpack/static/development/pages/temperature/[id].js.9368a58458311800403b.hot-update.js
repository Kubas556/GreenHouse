  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    ...
    if (initValue != undefined) {
      ...
      for (var i = 0; i < segCount; i++) {
        ...
        var line = '<div rotate=' + _handAngle + ' style="transform:rotate(' + _handAngle + 'deg)!important;width:' + lineContainerSizes.width + ';" class="lineContainer">' + '<div class="line"></div>' + '<div>' + '<div class="valueLine"></div>' + '<div>0</div>' + '</div>' + '</div>';
...
//# sourceMappingURL=[id].js.9368a58458311800403b.hot-update.js.map