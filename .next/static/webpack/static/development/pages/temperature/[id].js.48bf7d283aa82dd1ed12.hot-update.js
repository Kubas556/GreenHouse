...
function Termostat(props) {
  ...
  function onMove(e) {
    if (drag) {
      ...
      console.log(angle2);
      if (angle2 < 0) angle2 = -(angle2 - 120);else angle2 = -(angle2 - maxAngle + angleOverlap);
...
//# sourceMappingURL=[id].js.48bf7d283aa82dd1ed12.hot-update.js.map